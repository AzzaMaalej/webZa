...
class AnimauxController extends Controller
{
    ...
    public function afficheAnimalPourInternauteAction($immatriculation)
    {
        ...
        $animaux=$em->getRepository('RefugeBundle:Animal')->rechercheParImmatriculationDQL($immatriculation) ;
    ...
    public function afficheAnimalPourClientAction(Request $request,$immatriculation)
    {
        ...
        return $this->render('RefugeBundle:Animaux:afficher_animaux_client.html.twig',['animaux'=>$animaux,'cPanier'=>$cPanier,
            'panier'=>$panier, 'commentaires'=>$commentaires, 'idUser'=>$idUser,'user'=>$user,'refuge'=>$refuge]);
    ...
    public function modifierCommentaireAction(Request $request,$id){
        ...
        return $this->render('RefugeBundle:Animaux:modifier_commentaire_client.html.twig',['animaux'=>$animaux,'commentaire'=>$commentaire,'commentaires'=>$commentaires, 'idUser'=>$idUser,'refuge'=>$refuge,'cPanier'=>$cPanier,
