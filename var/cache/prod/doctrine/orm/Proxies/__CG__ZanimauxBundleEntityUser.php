...
namespace Proxies\__CG__\ZanimauxBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \ZanimauxBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'adresse', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'codePostale', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'numeroOrdre', '' . "\0" . 'ZanimauxBundle\\Entity\\User' . "\0" . 'demande', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
