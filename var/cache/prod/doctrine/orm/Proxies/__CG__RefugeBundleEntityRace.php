 ...
 */
class Race extends \RefugeBundle\Entity\Race implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RefugeBundle\\Entity\\Race' . "\0" . 'id', '' . "\0" . 'RefugeBundle\\Entity\\Race' . "\0" . 'race', '' . "\0" . 'RefugeBundle\\Entity\\Race' . "\0" . 'informations', '' . "\0" . 'RefugeBundle\\Entity\\Race' . "\0" . 'photo', '' . "\0" . 'RefugeBundle\\Entity\\Race' . "\0" . 'type'];
        }
